  ...
  public ModuleIOSparkMax(int index) {
    switch (index) {
      ...
      case 0:
        ...
        absoluteEncoderOffset = new Rotation2d(Math.PI / 2.0); // MUST BE CALIBRATED
        break;
        // Front right
      case 1:
        driveSparkMax =
    ...
    driveSparkMax.enableVoltageCompensation(8.0);
    turnSparkMax.enableVoltageCompensation(8.0);
