...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    // ! Add new autos here. The autogenerated one is bad because it includes all of the ones in the
    // chache of the RoboRIO.
    String[] autoNames = new String[] {"BlueLClose3", "BlueLMid3", "BlueLClose3Mid1Far"};
